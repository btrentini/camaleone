...
9. Click `Save as favourite...` to store a palette, then choose it from the favourites list to apply it later. There are some presets you can load and customize.
